...
# region setting
    ...
    def variable_setting(self):
        self.algorithm_set_name = "alex_a_11"
        self.algorithm_set = {'consider_len_list': [20],
                              'buy_discount_rate_list': [0.4, 0.5, 0.6],
                              'sell_discount_rate_list': [0.7, 0.8, 0.9],
                              'buy_power_threshold_list': [5, 10, 50],
                              'sell_power_threshold_list': [1, 1.5, 2],
                              'buy_accel_threshold_list': [0.5],
                              'sell_accel_threshold_list': [0.6, 0.7],
                              'buy_power_ratio_threshold_list': [100, 1000, 2000, 10000, 20000],
        ...
        self.end_time_list = ['0910', '0915', '0920', '0925', '0930', '0940']
...
# endregion DB Control
    ...
    def run_one_condition(self, consider_len, buy_discount_rate, sell_discount_rate, buy_power_threshold, sell_power_threshold, buy_accel_threshold, sell_accel_threshold, buy_power_ratio_threshold, over_open_price, date):
        ...
        df_record = pd.DataFrame(columns=['trade_index', 'code', 'buy_time', 'sell_time', 'buy_price', 'sell_price',
                                          'amount', 'profit', 'earning_rate', 'geo_earning_rate'])
        # 종목별 이터레이션
        trade_index = 0
    ...
    def make_record_summary_to_db(self, df_record, param_list, param_value_tup, date):
        ...
        for end_time in self.end_time_list:
